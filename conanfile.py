...
class ArbaDpatRecipe(ConanFile):
    project_namespace = "arba"
    project_base_name = "dpat"
    name = f"{project_namespace}-{project_base_name}"
    package_type = "header-library"

    # Optional metadata
    description = "A C++ library providing design pattern tools."
    url = "https://github.com/arapelle/arba-dpat"
    homepage = "https://github.com/arapelle/arba-dpat"
    ...
    def requirements(self):
        self.requires("arba-itru/[^0.5]", transitive_headers=True, transitive_libs=True)
