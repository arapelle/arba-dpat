...
constexpr unsigned hierarchy_superior_traits = dpat::hierarchy_superior_traits::optional;
...
public:
    ...
    scene_node() : dpat::under<graphics_engine, hierarchy_superior_traits>() {}
...
TEST(under_optional_tests, superior__direct_superior__ok)
{
    ut::application app;
...
TEST(under_optional_tests, const_superior__direct_superior__ok)
{
...
TEST(under_optional_tests, superior__indirect_superior__ok)
{
    ut::application app;
    ASSERT_EQ(&app, &app.gr_engine_uptr->root_scene_node.app());
}

TEST(under_optional_tests, const_superior__indirect_superior__ok)
{
    const ut::application app;
    ASSERT_EQ(&app, &app.gr_engine_uptr->root_scene_node.app());
}

TEST(under_optional_tests, has_superior__ok)
{
    const ut::application app;
...
TEST(under_optional_tests, set_superior__ok)
{
    ut::application app;
...
TEST(under_optional_tests, default_constructor__no_superior__ok)
{
    ut::application app;
    app.gr_engine_uptr->set_node();
    ASSERT_EQ(app.gr_engine_uptr.get(), &app.gr_engine_uptr->root_scene_node.engine());
}
