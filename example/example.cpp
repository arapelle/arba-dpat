...
class abstract_state : public dpat::state<abstract_state, dpat::state_machine<abstract_state>, int&, int&, const int&, int>
{
public:
    virtual ~abstract_state() override = default;
};

using state_machine = dpat::state_machine<abstract_state>;
